...
public class CafeteiraMachine {
    ...
    private void loadData() {
        ...
        if (file.exists()) {
            try {
                // Lê o JSON do arquivo e o converte para um objeto DadosCafeteira
                ...
                // Se houver um erro de leitura, inicializa com valores padrão
    ...
    public void saveData() {
        try {
            // Cria um objeto DadosCafeteira com os dados atuais da máquina
